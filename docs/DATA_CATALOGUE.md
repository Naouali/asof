...
- `symbol` comes from `configs/contractors.yaml`, a curated list of parent-company identifiers and their tickers, not from the data. A company outside that list is absent, not idle. Joint ventures are left out because they belong to no single ticker, and foreign-listed parents because their US tickers are depositary receipts. The government's own parent records lag acquisitions by months or years.
