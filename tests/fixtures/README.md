...
| `usaspending_transactions_lmt.csv` | **Recorded live** 2026-09-21 from the USAspending download service, trimmed from 536 Lockheed Martin contract actions to six, all 297 columns kept: a $514 million Air Force option under the Pentagon's embargo, a NASA modification, a $12 million de-obligation, a Homeland Security modification under the $1 million minimum, a Coast Guard order signed by Sikorsky, and one action of the Raytheon/Lockheed Javelin joint venture, which belongs to neither ticker. Tests zip it with the byte-order mark the real file opens with. |
